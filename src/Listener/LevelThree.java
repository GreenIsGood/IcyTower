...
public class LevelThree implements GLEventListener, KeyListener {   
    ...
    public void display(GLAutoDrawable gld) {
        ...
        if((Main.boy.getYPos()/45)<=yPosition && yPosition!=-0.2){
            ...
            Losing.setCurrentLevel("LevelThree");
            Main.setListener("LevelThree", "Losing");
        }        
        ...
        for(int i=0 ; i<pairs.length ; i++){
            pairs[i].setxFinal(drawBlocks(gl, 10+pairs[i].getxPos(),
                yPosPair[i], pairs[i].getLength()));
        }
        ...
        if(Main.boy.getYPos()+Main.boy.getYSpeed()>=1491){
            ...
            Winning.setCurrentLevel("LevelThree");
            Main.setListener("LevelThree", "Winning");
        } 
    }
        ...
        //Handle key for closing message
            ...
            move++;
                ...
                if(move == 1){
                    ...
                    Main.setListener("LevelThree", "Home");
                }
            }
        }
