...
public class Losing implements GLEventListener, KeyListener {
    
    private final String TEXTURE_NAME[] = {"Images/losing.png",
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == e.VK_RIGHT) {
            ...
            if(move == 0){
                Main.setListener("Losing", "Home");
            }
            else{
                if(currentLevel.equals("LevelOne")){
                    Main.setListener("Losing", "LevelOne");
                }
                else if(currentLevel.equals("LevelTwo")){
                    Main.setListener("Losing", "LevelTwo");
                }
                else if(currentLevel.equals("LevelThree")){
                    Main.setListener("Losing", "LevelThree");
                }
            }
        }
    }
    ...
    public static void setCurrentLevel(String currentLevel) {
        Losing.currentLevel = currentLevel;
    }
