...
public class Characters implements GLEventListener, KeyListener {
    
    private final String TEXTURE_NAME[] = {"Images/characters_background.png", 
        "Images/left.png", "Images/right.png", "Images/3d_name.png",
        "Images/yasser_name.png" ,"Images/classic_name.png", "Images/batman_name.png",
        "Images/cool_name.png", "Images/on.png", "Images/mute.png"};
    private TextureReader.Texture texture[] = new 
            TextureReader.Texture[TEXTURE_NAME.length];
    private int textures[] = new int[TEXTURE_NAME.length], index[] = {3, 4, 5, 6, 7};
    private int move = 0;
    ...
    public void display(GLAutoDrawable gld) {
        ...
        //Check if there is next or previous in characters
        if(move == 0){
            hasLeft = false;
            hasRight = true;
        }
        ...
        //Draw the name and image of character
        DrawSprite(gl, 45, 40, index[move], 3.5f); 
         
        //Draw the image of music
        if(Main.isMute()){
           DrawSprite(gl, 87, 87, 9, 1.7f);  
        }
        else{
            DrawSprite(gl, 87, 87, 8, 1.7f); 
        }
    }
    ...
    public void keyPressed(KeyEvent e) {
        if(e.getKeyCode() == e.VK_RIGHT){
            ...
            Main.boy = new Boy();
            //Set the image of boy with image of character
            if(move == 0){
                Main.boy.setImages("3d");
            }
            else if(move == 1){
                Main.boy.setImages("yasser");
            }
            else if(move == 2){
                Main.boy.setImages("classic");
            }
            else if(move == 3){
                Main.boy.setImages("batman");
            }
            else if(move == 4){
                Main.boy.setImages("cool");
            }
            Main.setListener("Characters", "Levels");
        }
        //Change the listener
