...
public class LevelOne implements GLEventListener, KeyListener {   
    ...
    private Pair[] pairs;
    private int[] yPosPair = new int[101];
    ...
    public void display(GLAutoDrawable gld) {
        ...
        if((Main.boy.getYPos()/45)<=yPosition && yPosition!=-0.2){
            ...
            Losing.setCurrentLevel("LevelOne");
            Main.setListener("LevelOne", "Losing");
        }
        ...
        for(int i=0 ; i<pairs.length ; i++){
            pairs[i].setxFinal(drawBlocks(gl, 6+pairs[i].getxPos(),
        ...
        if(Main.boy.getYPos()+Main.boy.getYSpeed()>=1491){
            ...
            Winning.setCurrentLevel("LevelOne");
            Main.setListener("LevelOne", "Winning");
        }        
    }
        ...
        //Handle key for closing message
            ...
            if ( isKeyPressed( KeyEvent.VK_RIGHT ) ) {
                ...
                if(move == 1){
                    ...
                    Main.setListener("LevelOne", "Home");
                }
            }
        }
